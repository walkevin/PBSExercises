...
#include <iostream>
	...
	void Example1::load(){
		sh.load("shaders/example1.glslv","shaders/example1.glslf");
		sh.use();
		createVBO();
	}
	...
	void Example1::createVBO(){
		Vertex Vertices[] =
		{
			...
			// Top
			{ { -0.2f, 0.8f, 0.5f, 1.0f }, { 0.0f, 1.0f, 0.0f, 1.0f } }, // 1
			{ { 0.2f, 0.8f, 0.5f, 1.0f }, { 0.0f, 0.0f, 1.0f, 1.0f } }, // 2
			{ { 0.0f, 0.8f, 0.5f, 1.0f }, { 0.0f, 1.0f, 1.0f, 1.0f } }, //3
			{ { 0.0f, 1.0f, 0.5f, 1.0f }, { 1.0f, 0.0f, 0.0f, 1.0f } },	// 4

			// Bottom
			{ { -0.2f, -0.8f, -0.5f, 1.0f }, { 0.0f, 0.0f, 1.0f, 1.0f } }, // 5
			{ { 0.2f, -0.8f, -0.5f, 1.0f }, { 0.0f, 1.0f, 0.0f, 1.0f } }, // 6
			{ { 0.0f, -0.8f, -0.5f, 1.0f }, { 0.0f, 1.0f, 1.0f, 1.0f } }, //7
			{ { 0.0f, -1.0f, -0.5f, 1.0f }, { 1.0f, 0.0f, 0.0f, 1.0f } },	// 8
